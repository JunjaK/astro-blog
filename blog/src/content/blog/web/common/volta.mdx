...
category: Web  
thumbnail: /files/blog/web/common/assets/volta.webp  
---  
...
<ImageLoader src="/files/blog/web/common/assets/volta.webp" alt="volta.png" />  
...
- volta list  
    - volta에 설치된 노드 또는 패키지매니저 정보를 확인  
      - ex) `volta list`: 아래 사진과 같이 현재 활성화된 volta 정보를 보여줌  
        <ImageLoader src="/files/blog/web/common/assets/Untitled-9988248.webp" alt="Untitled" />  
  
      - ex) `volta list node`: 아래 사진과 같이 volta에 설치된 Node 정보를 보여줌  
        <ImageLoader src="/files/blog/web/common/assets/Untitled1-9988257.webp" alt="Untitled 1" />  
...
- Package manager: 경로에 .volta 들어가 있는 것으로 변경  
    ...
    - `volta which npm (yarn, pnpm 동일)`를 통해 Volta에 설치된 패키지 매니저 Path 확인 가능  
      <ImageLoader src="/files/blog/web/common/assets/Untitled-9988452.webp" alt="Untitled" />  
