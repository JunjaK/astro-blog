...
const techIcons: Record<string, TechStackType> = {
  dark: {
    ...
    claudecode: { techName: 'Claude Code', iconUrl: '/images/icon/tech-stack/dark/claudecode.svg' },
    cloudflare: { techName: 'Cloudflare', iconUrl: '/images/icon/tech-stack/dark/cloudflare.svg' },
    expo: { techName: 'Expo', iconUrl: '/images/icon/tech-stack/dark/expo.svg' },
    gemma4: { techName: 'Gemma 4', iconUrl: '/images/icon/tech-stack/dark/gemma4.svg' },
    leaflet: { techName: 'Leaflet', iconUrl: '/images/icon/tech-stack/dark/leaflet.svg' },
    reactnative: { techName: 'React Native', iconUrl: '/images/icon/tech-stack/dark/reactnative.svg' },
    shadcn: { techName: 'shadcn/ui', iconUrl: '/images/icon/tech-stack/dark/shadcn.svg' },
    supabase: { techName: 'Supabase', iconUrl: '/images/icon/tech-stack/dark/supabase.svg' },
  },
  light: {
    ...
    claudecode: { techName: 'Claude Code', iconUrl: '/images/icon/tech-stack/light/claudecode.svg' },
    cloudflare: { techName: 'Cloudflare', iconUrl: '/images/icon/tech-stack/light/cloudflare.svg' },
    expo: { techName: 'Expo', iconUrl: '/images/icon/tech-stack/light/expo.svg' },
    gemma4: { techName: 'Gemma 4', iconUrl: '/images/icon/tech-stack/light/gemma4.svg' },
    leaflet: { techName: 'Leaflet', iconUrl: '/images/icon/tech-stack/light/leaflet.svg' },
    reactnative: { techName: 'React Native', iconUrl: '/images/icon/tech-stack/light/reactnative.svg' },
    shadcn: { techName: 'shadcn/ui', iconUrl: '/images/icon/tech-stack/light/shadcn.svg' },
    supabase: { techName: 'Supabase', iconUrl: '/images/icon/tech-stack/light/supabase.svg' },
  },
};
